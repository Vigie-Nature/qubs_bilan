...
# 
# # Import des donnees qubs a partir des exports standards
# source(here::here("functions", "create_df_qubs.R"))
source(here::here("programs", "import_local_data.R"))
...
Nombre total de participants au moment de l'export : `r length(unique(dt_qubs$user_id))`

Nombre total de sites au moment de l'export : `r length(unique(dt_qubs$site_id))`
...
DT::datatable(synthese_session_qubs,
              colnames = c("Protocole", "Année", "Sites", "Participants", "Sessions",
                           "Sessions\nvides"),
              extensions = "Buttons",
              options = list(dom = 'Blfrtip',
                             buttons = c("copy", "csv")),
